...
usage() {
    echo "Penggunaan: $0 [start|stop|reset|reset-room] [ruang] [kursus/nama-container] [course_code]"
    echo "Daftar Ruang: f491, f492, f4111, f4112"
    echo "Daftar Kursus: netbegin, netadmin"
    echo ""
    echo "Contoh mulai (nempel ke sesi yang sudah dibuat via lxd-control):"
    echo "  $0 start f491 netbegin 1CNAR261442K"
    echo "Contoh mulai (mode testing cepat, auto-generate sesi baru):"
    echo "  $0 start f491 netbegin"
